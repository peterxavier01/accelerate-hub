...
/**
 * This sanity GROQ query returns startups data from sanity. Also, it can be used to filter startup data by title, category or author's name.
 */
...
/**
 * Get all startups created by a single user
 */
